...
#ifndef TEST_NUOVI_HEADERS_TLIST_H
#define TEST_NUOVI_HEADERS_TLIST_H
#include "TInfo.h"
...
TNode *list_search_at_index(TList, int);

TNode *list_search_unordered(TList, TInfo);

TNode *list_insert_at_index(TList, TInfo, int);

TList list_delete_unordered(TList, TInfo);
#endif //TEST_NUOVI_HEADERS_TLIST_H
