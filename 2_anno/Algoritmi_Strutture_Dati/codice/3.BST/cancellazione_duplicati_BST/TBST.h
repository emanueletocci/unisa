...
#ifndef CANCELLAZIONE_DUPLICATI_BST_TBST_H
#define CANCELLAZIONE_DUPLICATI_BST_TBST_H
#include "TInfo.h"
#include<stdbool.h>
...
int binarytree_sum_nodes(TBinaryTree);
...
int binarytree_sum_leaves(TBinaryTree);
...
#endif //CANCELLAZIONE_DUPLICATI_BST_TBST_H
